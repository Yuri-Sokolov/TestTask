<div class="footer__container">
    <div class="footer__info">
        <a class="footer__logo" href="/">
            <img class="footer__logo-icon" src="/images/iSpring-footer-logo.svg" alt="iSpring Logo">
        </a>
        <p class="footer__info-description">
            © 2001-2020 iSpring Solutions Inc. All rights reserved. Terms of Use | Privacy Policy
        </p>
    </div>
    <div class="footer__subscribe subscribe">
        ...
        <form class="subscribe__form" method="post" id="subscribeForm">
